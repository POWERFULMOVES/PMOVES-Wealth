# PMOVES.AI Integration Guide for Wealth Tracker

## Integration Complete

The PMOVES.AI integration template has been applied to Wealth Tracker.
...
async def startup():
    await announce_service(
        slug="wealth-tracker",
        name="Wealth Tracker",
        url=f"http://wealth-tracker:8096",
        port=8096,
        tier="agent"
    )
```
...
docker compose exec wealth-tracker env | grep PMOVES
